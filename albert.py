...
if __name__ == '__main__':
    ...
    model = TFAlbertForSequenceClassification.from_pretrained('albert-base-v2', finetuning_task='text-classification',
                                                            num_labels=1)
    ...
    result_output.to_csv("result/albert_new.csv", index=False, quoting=3)

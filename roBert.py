...
if __name__ == '__main__':
    ...
    model = TFRobertaForSequenceClassification.from_pretrained('models/roberta-base', finetuning_task='text-classification',
                                                            num_labels=1)
    ...
    result_output.to_csv("result/RoBert_new.csv", index=False, quoting=3)
